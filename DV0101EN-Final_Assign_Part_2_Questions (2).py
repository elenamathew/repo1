...
exp_data=recession_data.groupby(['Vehicle_Type', 'unemployment_rate'])['Automobile_Sales'].mean().reset_index()
R_chart4= dcc.Graph(figure=px.bar(exp_data,
x='Vehicle_Type',
y='unemployment_rate',
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        yas= recssion_data.groupby('Year')['Automobile_Sales'].mean().reset_index()
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        avr_vdata = recession_data.groupby('Vehicle_Type')['Automobile_Sales'].mean().reset_index()
        ...
        exp_data=recession_data.groupby('Vehicle_Type')['Advertisement_Expenditure'].sum().reset_index()
...
return [html.Div(className='chart-item', children=[Y_chart1]) html.Div(className='chart-item', children=[Y_chart2]),  html.Div(className='chart-item', children=[Y_chart3]),  html.Div(className='chart-item', children=[Y_chart4])]
